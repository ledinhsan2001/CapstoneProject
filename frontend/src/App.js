                ...
                <div className="auth-inner">
                    <Routes>
                        ...
                        <Route
                            ...
                            element={<Main content={path.SELL_APARTMENTS} />}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            element={<Main content={path.SELL_FRONT_HOMES} />}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            element={<Main content={path.SELL_PROJECT_LAND} />}
                        />
                        <Route
                            path={path.SELL_SHOP}
                        ...
                        <Route
                            ...
                            element={<Main content={path.RENTAL_APARTMENTS} />}
                        />
                        <Route
                            path={path.RENTAL_FRONT_HOMES}
                            element={<Main content={path.RENTAL_FRONT_HOMES} />}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            element={<Main content={path.RENTAL_IN_COMPOUND} />}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            element={<Main content={path.RENTAL_MOTEL_ROOM} />}
                        />
                        <Route
                        ...
                        <Route
                            ...
                            element={<Main content={path.RENTAL_WAREHOUSE} />}
                        />
                        <Route
                            path={path.RENTAL_WHOLE_HOUSE}
                            element={<Main content={path.RENTAL_WHOLE_HOUSE} />}
                        />
                    </Routes>
                </div>
            </div>
